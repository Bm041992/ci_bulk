...
{ 
    ...
    private function _get_datatables_query($postData)
    {
        ...
        $this->db->select('admins.name as user_name,admins.role,admins.email,contacts.id,contacts.name,contacts.company,contacts.address, cp.phone_number');
        ...
        $this->db->join('admins', 'contacts.user_id = admins.id', 'inner');
